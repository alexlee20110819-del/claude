...
> **This repository holds two unrelated projects.** The dashboard documented
> below lives at the repository root. A separate static marketing site for
> Thomson & Foley Property Maintenance lives in [`site/`](site/README.md) and is
> generated by [`tools/`](tools/) — it shares no code, dependencies or build with
> the dashboard.
